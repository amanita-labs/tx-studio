// src/features/builder/tabs/tx-body/outputs/TransactionOutputsTab.tsx
'use client';
...
export function TransactionOutputsTab() {
  ...
  const handleAdd = async () => {
    ...
    try {
      ...
      toast.success('Transaction output added');
      
      setAddress('');
      setAmount('');
      setErrors({});
    } catch (error) {
      toast.error(`Failed to add output: ${error instanceof Error ? error.message : 'Unknown error'}`);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <Card className="h-full">
      <CardHeader>
        ...
        <CardDescription>
          Add transaction outputs (recipients)
        </CardDescription>
      </CardHeader>
