// src/features/builder/tabs/certificates/AccountUnregistrationTab.tsx
'use client';
...
export function AccountUnregistrationTab() {
  ...
  const handleBuild = async () => {
    ...
    setLoading(true);
    try {
      // TODO: Implement buildAccountUnregistrationCert in transaction-builder.ts
      const certificate: BuilderCertificate = {
        id: `account-unregistration-${Date.now()}`,
        type: 'AccountUnregistration',
        data: {
      ...
      toast.success('Account unregistration certificate added to transaction');
  ...
  return (
    <Card className="h-full">
      <CardHeader>
        ...
        <CardDescription>
          Unregister an account (Conway era feature)
        </CardDescription>
      </CardHeader>
